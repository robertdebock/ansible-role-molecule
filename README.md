...
The purpose of this role is to install and configure molecule on your system.
...
- molecule_parameter: Description of values. [default: value]
...
- name: molecule
  ...
  roles:
    ...
    - role: robertdebock.molecule
      molecule_parameter: value
```

To install this role:
- Install this role individually using `ansible-galaxy install robertdebock.molecule`

Sample roles/requirements.yml: (install with `ansible-galaxy install -r roles/requirements.yml
```
---
- name: robertdebock.bootstrap
- name: robertdebock.molecule
```
